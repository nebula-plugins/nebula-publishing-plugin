...
class ApiScopePluginIntegrationSpec extends IntegrationHelperSpec {
    ...
    def 'dependencies not in compileApi stay out of ivy compile scope'() {
        def graph = new DependencyGraphBuilder()
                .addModule('test.nebula:a:1.0.0')
                .addModule('test.nebula:b:1.0.0')
                .build()
