...
abstract class BaseMavenNebulaShadowJarPublishPluginIntegrationSpec extends BaseIntegrationTestKitSpec {
...
""")
    ...
    boolean fileWasPublished(String fileName, String path = 'testrepo/test/nebula/mavenpublishingtest/0.1.0/') {
