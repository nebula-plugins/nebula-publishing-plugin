...
abstract class BaseIvyNebulaShadowJarPublishPluginIntegrationSpec extends BaseIntegrationTestKitSpec {

    abstract String getShadowPluginId()
    abstract String getShadowPluginVersion()
...
""")
    ...
    boolean fileWasPublished(String fileName, String path = 'build/distIvy/test.nebula/ivypublishingtest/0.1.0/') {
